...
<body>
    ...
    <div class="container">
		...
		<div class="col-sm-4 col-lg-4 col-md-4">
             <div class="thumbnail">
				<h4 style="text-align: center;">Category: '.$Rows[6].'</h4>
	...
	<center><a onclick="" href="initialize.php?ProductID='.$Rows[0].'&Amount='.$Rows[5].'&Size='.$Rows[3].'&Color='.$Rows[4].'"  style="margin-bottom: 5px;" class="btn btn-primary">Buy Now</a></center>
            </div>
        </div>
		';
		}?>
